        ...
        $out = [
            ...
            'sync_template' => [''] + SB::option('SELECT  sync_csv_template.id,
                                                          ...
                                                          (SELECT GROUP_CONCAT("<",sync_csv_column.element,">")
                                                            ...
                                                            INNER JOIN sync_csv_column ON sync_csv_column.id = sync_template_m2n_column.column_id
                                                            WHERE sync_template_m2n_column.template_id = sync_csv_template.id
                                                            ORDER BY sync_template_m2n_column.id
                                                          ) AS list
