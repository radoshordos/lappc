...
{{ Form::open(array('action' => 'PpcRulesController@store', 'class' => 'form-horizontal', 'role' => 'form')) }}
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <?php echo Form::select('is_sell', array("" => "", "NO" => "NE", "YES" => "ANO"), NULL, array('class' => 'form-control','placeholder' => 'Je možné nyní produkt zakoupit?')); ?>
        </div>
    </div>
    <div class="form-group">
        <label for="is_action" class="col-sm-2 control-label">Produkt v akci</label>
        <div class="col-sm-6">
            <?php echo Form::select('is_action', array("" => "", "NO" => "NE", "YES" => "ANO"), NULL, array('class' => 'form-control','placeholder' => 'Je nyní produkt v akci?')); ?>
        </div>
    </div>
    <div class="form-group">
        <label for="is_ready_send" class="col-sm-2 control-label">Připraven k odeslání</label>
        <div class="col-sm-6">
            <?php echo Form::select('is_ready_send', array("" => "", "NO" => "NE", "YES" => "ANO"), NULL, array('class' => 'form-control','placeholder' => 'Je produkt skladem?')); ?>
        </div>
    </div>
    <div class="form-group">
