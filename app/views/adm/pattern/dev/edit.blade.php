...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {{ Form::input('number','id',NULL,array('min'=> '1','max'=> '999','required' => 'required','class'=> 'form-control', 'placeholder'=> 'ID určené pro
        výrobce')) }}
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {{ Form::select('default_warranty_id',$select_warranty, NULL, array('required' => 'required', 'class'=> 'form-control',
        'placeholder'=> 'Výchozí záruka pro
        výrobce')) }}
    </div>
</div>
<div class="form-group">
    ...
    <div class="col-sm-10">
        {{ Form::select('default_sale_id',$select_sale, NULL, array('required' => 'required', 'class'=> 'form-control', 'placeholder'=>
        'Výchozí sleva pro
        výrobce')) }}
    </div>
</div>
<div class="form-group">
    ...
    <div class="col-sm-10">
        {{ Form::select('default_availibility_id',$select_availability, NULL, array('required' => 'required', 'class'=> 'form-control',
        'placeholder'=> 'Výchozí
