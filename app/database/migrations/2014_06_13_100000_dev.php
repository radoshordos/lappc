...
class Dev extends Migration
{
    public function up()
    {
        Schema::create('dev', function (Blueprint $table) {
            ...
            $table->foreign('default_availability_id')->references('id')->on('items_availability')->onUpdate('cascade')->onDelete('no action');
        });
    }
    ...
    public function down()
    {
        Schema::dropIfExists('dev', function (Blueprint $table) {
            ...
            $table->dropForeign('default_availability_id');
        });
    }
}