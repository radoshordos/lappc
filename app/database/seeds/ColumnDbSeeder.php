...
class ColumnDbSeeder extends Seeder
{
    ...
    public function run()
    {
        $column_db = [
            ...
            ['columna_id' => '53', 'columna_id_tables' => '2', 'columna_id_helpful' => '2', 'columna_visible_filter' => '1', 'columna_visible_db2csv' => '1', 'columna_visible_cvs2xml' => '1', 'columna_name' => 'iprice'],
