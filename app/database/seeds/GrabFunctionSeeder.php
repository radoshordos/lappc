...
class GrabFunctionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $filter2type = [
            ...
            ['params' => 0, 'ft_id' => '10', 'ft_id_mode' => '1', 'ft_visible' => '1', 'ft_function_name' => 'stripTags', 'ft_function' => 'stripTags($mixed)', 'ft_name' => 'Odstranit z řetězce HTML a PHP tagy'],
            ['params' => 1, 'ft_id' => '11', 'ft_id_mode' => '2', 'ft_visible' => '1', 'ft_function_name' => 'setValueToColumn', 'ft_function' => 'setValueToColumn($value1)', 'ft_name' => 'Nastaví zadanou hodnotu'],
            ...
            ['params' => 0, 'ft_id' => '16', 'ft_id_mode' => '1', 'ft_visible' => '1', 'ft_function_name' => 'trim', 'ft_function' => 'trim($mixed)', 'ft_name' => 'Odstranit netisknutelné znaky'],
            ['params' => 0, 'ft_id' => '17', 'ft_id_mode' => '1', 'ft_visible' => '1', 'ft_function_name' => 'ucfirst', 'ft_function' => 'ucfirst($mixed)', 'ft_name' => 'Změní první písmeno řetězce na velké'],
            ['params' => 0, 'ft_id' => '18', 'ft_id_mode' => '1', 'ft_visible' => '1', 'ft_function_name' => 'strToUpper', 'ft_function' => 'strToUpper($mixed)', 'ft_name' => 'Změnit řetězec na velká písmena '],
            ['params' => 0, 'ft_id' => '19', 'ft_id_mode' => '1', 'ft_visible' => '1', 'ft_function_name' => 'strToLower', 'ft_function' => 'strToLower($mixed)', 'ft_name' => 'Změnit řetězec na malá písmena'],
            ...
            ['params' => 1, 'ft_id' => '21', 'ft_id_mode' => '4', 'ft_visible' => '1', 'ft_function_name' => 'explode2ColumnArrays', 'ft_function' => 'explode2ColumnArrays($str, $delimiter = "LINERN")', 'ft_name' => 'Převod do pole'],
        ...
        foreach ($filter2type as $row) {
            ...
            DB::table('grab_function')->insert([
                ...
                'params'   => isset($row['params']) ? $row['params'] : 2,
