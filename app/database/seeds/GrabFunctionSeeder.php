...
class GrabFunctionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $filter2type = [
            ...
            ['params' => 1, 'ft_id' => '21', 'ft_id_mode' => '4', 'ft_visible' => '1', 'ft_function_name' => 'explode2ColumArrays', 'ft_function' => 'explode2ColumArrays($str, $delimiter = "LINERN")', 'ft_name' => 'Převod do pole'],
